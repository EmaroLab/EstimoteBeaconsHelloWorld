...
/*        UID = id(applicationContext)
        ...
        val pinkBeacon = ProximityZoneBuilder()
                ...
                .onEnter{
                    ...
                    text.text = "Currently near pink beacon"
                }
                .onExit{
                    Log.d("Debug.. ", "Previously you were near the pink beacon")
                    text.text = "Previously you were near pink beacon"
                }
                .build()
        ...
        val yellowBeacon = ProximityZoneBuilder()
                ...
                .onEnter{
                    ...
                    text.text = "Currently near yellow beacon"
                }
                .onExit{
                    Log.d("Debug.. ", "Previously you were near the yellow beacon")
                    text.text = "Previously you were near yellow beacon"
                }
                .build()
